...
const Footer = () => {
    return (
        <footer className="text-white py-20 bg_gradient " id="footer">
            <div className="container mx-auto px-20 lg:px-20 py-20 flex flex-col gap-10 md:flex-row justify-between border-t border-slate-800">
                <div className="flex">
                    <p className="font-bold text-center">
                        Flavor<span className="text-green-500 text-xl">Flare</span>
                    </p>
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex mt-4 gap-3">
                        <a
                            href='https://www.facebook.com/profile.php?id=100072521124439'
                        ...
                        <a
                            href='https://www.instagram.com/sonalikeshri_23/'
